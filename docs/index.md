...
hero:
  ...
  actions:
    ...
    - theme: alt
      text: GitHub
      link: https://github.com/carlelieser/stark
...
features:
  ...
  - icon: ✅
    ...
    details: Every task must pass explicit acceptance criteria before completion. No more guessing whether work actually solves the problem - STARK ensures solutions meet requirements systematically.
